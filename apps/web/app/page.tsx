      ...
      <header className="sticky top-0 z-50 glass border-b border-[var(--border)]">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-6">
            ...
            <a
              href="#try-it-now"
              className="text-xs font-semibold text-brand-600 dark:text-brand-400 bg-brand-50 dark:bg-brand-900/30 px-2.5 py-1 rounded-full border border-brand-200 dark:border-brand-800/40 hover:bg-brand-100 transition-colors"
            >
              ⚡ Live Demo (No Login)
            </a>
          </div>
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Link
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-[var(--border)] px-6 py-3 text-sm font-semibold text-foreground hover:bg-surface transition-all"
              >
                Start creating free →
              </Link>
            </div>
